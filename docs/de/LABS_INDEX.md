...
Lab-Titel und HTTP-Endpoints sind auf Englisch.

Jedes Lab folgt demselben Ablauf: **Ziel → Vor dem Start → Schritte → Was notieren? → Abschlusskriterium → Wenn das Ergebnis anders ist → Arbeitsblatt**. Zuerst Evidence sammeln, danach Schlussfolgerungen ziehen.
...
Jeder Block dauert 120 Minuten.

Hot Customer in den Workshops 2–4: **CustomerId 123**.
