# Laby — EF Core Through the Eyes of a DBA

**Zacznij tutaj.**

Tytuły labów i endpointy HTTP są po angielsku.

Każdy lab używa tego samego rytmu: **Cel → Przed startem → Kroki → Co zapisać → Kryterium zakończenia → Gdy wynik jest inny → Arkusz**. Najpierw zbierz evidence, dopiero potem formułuj wniosek.
...
Każdy blok trwa 120 minut.

Hot customer używany w workshopach 2–4: **CustomerId 123**.
